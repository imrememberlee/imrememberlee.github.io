import{_ as s,m as d}from"./multiYAxisLineData-BlQgi5Eq.js";import{r as m,n as c}from"./vue.esm-bundler-DwFmfttj.js";import"./BaseEchart-BQnVcyB1.js";import"./universalTransition-DVg0_tq2.js";const p={title:"业务组件/MultiYAxisLine多y轴折线图",component:s,tags:["autodocs"],argTypes:{width:{control:"number",description:"宽度"},height:{control:"number",description:"高度"}},args:{width:1200,height:360},render:o=>({components:{DigiMultiYAxisLine:s},setup(){const t=m();return c(()=>{var e;(e=t.value)==null||e.setOption(d)}),{args:o,digiMultiYAxisLineRef:t}},template:`
      <div>
